            ...
            (pathname?.includes("/team/") ? null : (
              <div className="flex max-sm:flex-col ">
                <div className="px-[4vw] py-[2vw] max-sm:gap-5 flex flex-col justify-center max-sm:items-center">
                  ...
                  <h3 className="sm:text-[1.2vw] dark:text-white/60 max-sm:text-center  max-sm:text-sm">
                    {" "}
                    Helping students to bridge the gap between theory and
                    practice. <br className="max-sm:hidden" />
                    ...
                    businesses and <br className="max-sm:hidden" />
                    their community.
                  </h3>
