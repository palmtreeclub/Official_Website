...
export default function AboutUs() {
  return (
    <div className="w-full sm:h-[90%] max-sm:h-[93%]  flex sm:flex-row max-sm:flex-col-reverse  bg-green-400 dark:bg-green-900">
      <div className="sm:w-[60%] max-sm:h-[80%] max-sm:w-full flex flex-col  justify-center items-center">
        <div className="px-[6vw] flex flex-col  justify-center items-center">
          ...
          >
            At Palm Tree Club, our mission is to cultivate a dynamic community
            of student developers who are not just interested in technology but
            are driven by a shared passion for solving real-world challenges. We
          ...
          <motion.div
            ...
            transition={{ duration: 0.9 }}
            viewport={{ once: true }}
            className="bg-yellow-500 relative  max-sm:text-xl sm:text-[1.5vw] w-max px-[2vw] py-[.5vw] rounded-full text-white font-semibold mt-[2vw] hover:bg-yellow-500/80 transition-all duration-300"
          >
            Lern More
          </motion.div>
        </div>
