  ...
  return (
    <section className="flex flex-col w-full h-full justify-center items-center">
      <div className="flex w-4/5 text-center h-4/5 max-md:flex-col justify-center items-center">
        ...
        <h1 className="text-yellow-500 w-max absolute cursor-pointer hover:text-yellow-700 font-semibold duration-300 transition-all right-[5vw] text-[1.5vw] bottom-[2vw]">
