  ...
  return (
    <>
      <div>
        ...
        <main>
          <svg
            className="max-sm:scale-75 max-sm:w-[80vw] sm:w-[50vw] sm:h-[70vh]"
          ...
          <p
            id="errorText"
            className="text-green-600 max-sm:text-xl sm:text-[1.2vw]"
          >
          ...
          <a
            id="errorLink"
            href="/"
            className=" max-sm:text-xl sm:text-[1.2vw]"
          >
            Go Back
          </a>
        </main>
